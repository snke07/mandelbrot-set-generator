...
public class MandelbrotFractalVisualizer implements MandelbrotSetReceiver {
    ...
    private static final Color[] PALETTE = { Color.black, Color.white };
    ...
    public void drawFractal() {
        this.generator = new MandelbrotSetGenerator(MAX_THREADS, MAX_ITERATIONS, this);
    ...
    public void receiveSet(List<MandelbrotNumber> numbers) {
        ...
        Map<MandelbrotNumber, Pixel> pixelMapping = this.generator.getPixelMapping();
        ...
        try {
            ...
            Logger.getLogger("Visualizer").log(Level.WARNING, "Failed to dump image to a file.", e);
        }
    }
}
